...
```bash
test -f "/home/luke/Cowork Projects/Salesforce Workspace/.mcp.json" && echo "EXISTS" || echo "MISSING"
```
...
```bash
test -L "/home/luke/Cowork Projects/Salesforce Workspace/.git/hooks/pre-commit" && echo "SYMLINK" \
  || test -f "/home/luke/Cowork Projects/Salesforce Workspace/.git/hooks/pre-commit" && echo "FILE" \
  || echo "MISSING"
```
...
```bash
readlink -f "/home/luke/Cowork Projects/Salesforce Workspace/.git/hooks/pre-commit"
```
...
ln -sf ~/.claude/hooks/git-pre-commit \
  "/home/luke/Cowork Projects/Salesforce Workspace/.git/hooks/pre-commit"
```
...
python3 -c "
import yaml, sys
with open('/home/luke/Cowork Projects/Salesforce Workspace/.claude/context.yaml') as f:
